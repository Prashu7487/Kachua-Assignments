...
def fuzzMain(ir, params, timeLimit=0) :
    ...
    while True:
        ...
        print(f"[fuzz] Fuzzing with Input ID : {pickedInput.data}")
        ...
        if coverageInfo.compareCoverage(curr_metric=coverageInfo.curr_metric,total_metric=coverageInfo.total_metric):
